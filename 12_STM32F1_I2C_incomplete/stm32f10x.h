...
enum gpio_mode {
    GPIO_OUTPUT_MODE_PUSHPULL = 0,
    GPIO_OUTPUT_MODE_OPENDRAIN = 1,
    GPIO_AF_MODE_PUSHPULL = 2,
    GPIO_AF_MODE_OPENDRAIN = 3,

    GPIO_INPUT_MODE_ANALOG = 4,
    GPIO_INPUT_MODE_INPUTFLOATING = 5,
    GPIO_INPUT_MODE_PULL_DOWN_OR_UP = 6
};
